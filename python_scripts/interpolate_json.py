...
cap = cv2.VideoCapture('/Users/simendomaas/Dokumenter_lokal/Media/Vågå/angle1.mp4')
#print("captured")
fps = cap.get(cv2.CAP_PROP_FPS)

# Predict with the model
#results = model('/Users/simendomaas/Documents/Skolearbeid/Masteroppgave/Media/DSCF1414.MOV', save = True)
results = model('/Users/simendomaas/Dokumenter_lokal/Media/Vågå/angle1.mp4', save = True)
...
# Export to JSON
with open('bounding_boxes_angle1.json', 'w') as f:
    json.dump(bbox_data_to_export, f)

with open('bounding_boxes_angle1.json', 'r') as file:
...
#combined_detections.append(final_timestamp) ##tror ikke jeg trenger denne lenger

with open('interpolated_bounding_boxes_angle1.json', 'w') as f:
